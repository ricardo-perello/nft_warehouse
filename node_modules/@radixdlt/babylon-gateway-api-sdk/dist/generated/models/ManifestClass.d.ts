 ...
 * @export
 */
export declare const ManifestClass: {
    readonly General: "General";
    readonly Transfer: "Transfer";
    readonly PoolContribution: "PoolContribution";
    readonly PoolRedemption: "PoolRedemption";
    readonly ValidatorStake: "ValidatorStake";
    readonly ValidatorUnstake: "ValidatorUnstake";
    readonly ValidatorClaim: "ValidatorClaim";
    readonly AccountDepositSettingsUpdate: "AccountDepositSettingsUpdate";
};
export type ManifestClass = typeof ManifestClass[keyof typeof ManifestClass];
export declare function ManifestClassFromJSON(json: any): ManifestClass;
export declare function ManifestClassFromJSONTyped(json: any, ignoreDiscriminator: boolean): ManifestClass;
export declare function ManifestClassToJSON(value?: ManifestClass | null): any;
