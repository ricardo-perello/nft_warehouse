 ...
 *
 * @export
 * @interface AccountDepositPreValidationResponse
 */
export interface AccountDepositPreValidationResponse {
    /**
     *
     * @type {LedgerState}
     * @memberof AccountDepositPreValidationResponse
     */
...
/**
 * Check if a given object implements the AccountDepositPreValidationResponse interface.
 */
export declare function instanceOfAccountDepositPreValidationResponse(value: object): boolean;
export declare function AccountDepositPreValidationResponseFromJSON(json: any): AccountDepositPreValidationResponse;
export declare function AccountDepositPreValidationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountDepositPreValidationResponse;
export declare function AccountDepositPreValidationResponseToJSON(value?: AccountDepositPreValidationResponse | null): any;
