 ...
 * @export
 */
export declare const NativeResourceOneResourcePoolUnitValueKindEnum: {
 ...
 */
export declare function instanceOfNativeResourceOneResourcePoolUnitValue(value: object): boolean;
export declare function NativeResourceOneResourcePoolUnitValueFromJSON(json: any): NativeResourceOneResourcePoolUnitValue;
export declare function NativeResourceOneResourcePoolUnitValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): NativeResourceOneResourcePoolUnitValue;
export declare function NativeResourceOneResourcePoolUnitValueToJSON(value?: NativeResourceOneResourcePoolUnitValue | null): any;
