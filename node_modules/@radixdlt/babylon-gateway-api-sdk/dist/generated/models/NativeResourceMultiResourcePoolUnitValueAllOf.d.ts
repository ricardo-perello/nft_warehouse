 ...
 * @export
 */
export declare const NativeResourceMultiResourcePoolUnitValueAllOfKindEnum: {
 ...
 */
export declare function instanceOfNativeResourceMultiResourcePoolUnitValueAllOf(value: object): boolean;
export declare function NativeResourceMultiResourcePoolUnitValueAllOfFromJSON(json: any): NativeResourceMultiResourcePoolUnitValueAllOf;
export declare function NativeResourceMultiResourcePoolUnitValueAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NativeResourceMultiResourcePoolUnitValueAllOf;
export declare function NativeResourceMultiResourcePoolUnitValueAllOfToJSON(value?: NativeResourceMultiResourcePoolUnitValueAllOf | null): any;
